...
struct llama_model {
    ...
    // LowGPU v1 3-bit vocab: embedding + LM head stay in packed codes (no FP16
    // expansion). Non-zero version means token_embd.weight / output.weight are
    // absent and the six sidecar tensors below carry the vocab instead.
